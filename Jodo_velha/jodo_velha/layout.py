...
def render_lay(*args):
        ...
        Columns(
            [
                ...
                Columns((  # G7
                    ...
                    # I9
                    Panel(
                        Text(i, justify='center', style='b red'),
                        width=7,
                        height=3,
                        subtitle='⁹',
                        title_align='center',
                        style='purple4',
                    ),  # testar sem border_bold no telefone.
                )),
                # footer
                Panel(
    ...
    display = Panel(grupo, width=50, height=17, style='red')

    console.rule('[b][blue]GAMING[blue/][b/]', style='blue')
    console.print(display, justify='center')
    console.rule(style='b blue')

    console.print(
        'Click Ctrl to play...',
        style='b blink blue encircle',
        justify='center',
    )
